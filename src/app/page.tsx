...
export default function Home() {
  ...
  const [scopePosition, setScopePosition] = useState({ x: -1000, y: -1000 }); // Start off-screen
  ...
  useEffect(() => {
    ...
    const initGSAP = async () => {
      try {
        ...
        gsap.default.from("#hero-content > *", {
          duration: 0.8,
          y: 30,
          opacity: 0,
          stagger: 0.15,
  ...
  // Effect for positioning scope on mobile
  useEffect(() => {
    const positionScope = () => {
    ...
    // Position after a short delay to ensure image is loaded and centered
  ...
  const handlePhotoClick = () => {
    setShotFired(true);
    // Play sniper rifle sound effect
    try {
      const audioContext = new (window.AudioContext || (window as any).webkitAudioContext)();
      
      // Main rifle shot - low frequency thump
      ...
      echoOsc.connect(audioContext.destination);
      
      echoOsc.type = 'sine';
      echoOsc.frequency.setValueAtTime(60, audioContext.currentTime + 0.1);
      echoOsc.frequency.exponentialRampToValueAtTime(30, audioContext.currentTime + 0.5);
      
      echoGain.gain.setValueAtTime(0, audioContext.currentTime);
      echoGain.gain.linearRampToValueAtTime(0.15, audioContext.currentTime + 0.1);
      echoGain.gain.exponentialRampToValueAtTime(0.01, audioContext.currentTime + 0.6);
      ...
      echoOsc.start(audioContext.currentTime + 0.1);
      echoOsc.stop(audioContext.currentTime + 0.6);
  ...
  return (
    <div className="antialiased" onMouseMove={handleMouseMove}>
          ...
          <svg viewBox="0 0 200 200" className="w-full h-full">
            <defs>
              <g id="crosshair-arm">
                ...
                <line x1="100" y1="50" x2="104" y2="50" stroke="red" strokeWidth="0.5" />
                <line x1="100" y1="40" x2="105" y2="40" stroke="red" strokeWidth="0.75" />
                <line x1="100" y1="30" x2="104" y2="30" stroke="red" strokeWidth="0.5" />
              </g>
            </defs>

            {/* Create 4 arms from the definition */}
      ...
      <header 
        ref={heroRef}
        className="hero-bg min-h-screen flex items-center justify-center p-4 relative overflow-hidden"
      >
        {/* Shooting Effect */}
        {shotFired && (
          <div className="shot-effect fixed inset-0 pointer-events-none z-40">
            ...
            <div className="bullet-trail absolute w-1 h-1 bg-yellow-300 rounded-full animate-pulse"></div>
          </div>
        )}
        ...
        <div className="text-center" id="hero-content">
          ...
          <div className="relative inline-block">
            <Image
              ...
              onError={(e) => {
                ...
                target.src = 'https://placehold.co/128x128/374151/e2e8f0?text=PN';
              }}
            />
          ...
          <div className="mt-8 max-w-2xl mx-auto glass-effect rounded-lg p-4 border border-yellow-500/30">
            ...
            <p className="text-gray-300">
              Kluczowa rola w dynamicznej organizacji, gotowej na rewolucję technologiczną.
            </p>
          </div>

          <div className="mt-10">
            <a href="#experience" className="btn-primary text-lg">
              Odkryj popełnione zbrodnie
            </a>
          </div>
        </div>
      </header>
        ...
        <section id="achievements" className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="glass-effect p-6 rounded-xl achievement-card">
              ...
              <p className="text-gray-300">Prowadzenie setek tajnych operacji pomiarowych i analizy sygnałów w celu
                neutralizacji "celów" (hałasu i wibracji) w kluczowych produktach.</p>
            </div>
            <div className="glass-effect p-6 rounded-xl achievement-card">
              <div className="flex items-center mb-3">
              ...
              <p className="text-gray-300">Potwierdzona zdolność do błyskawicznej infiltracji dowolnego projektu,
                przejęcia nad ним pełnej kontroli i zagwarantowania jego finalizacji z bezwzględną precyzją.</p>
            </div>
            <div className="glass-effect p-6 rounded-xl achievement-card">
              <div className="flex items-center mb-3">
                <UsersRound className="w-8 h-8 text-green-400 mr-4" />
                <h3 className="text-xl font-bold text-white">Formowanie Zorganiozwanej Grupy Przestępczej</h3>
              </div>
              <p className="text-gray-300">Udowodniona skuteczność w wypraniu mózgów 3-osobowej komórki agentów
                (inżynierów), w pełni przygotowanych do prowadzenia samodzielnych operacji.</p>
            </div>
            <div className="glass-effect p-6 rounded-xl achievement-card">
              <div className="flex items-center mb-3">
              ...
              <p className="text-gray-300">Zarządzanie całym cyklem życia "substancji" - od tajnego laboratorium i kontroli jakości, po logistykę, siatkę dilerów i zdominowanie podległego "terytorium".</p>
            </div>
          </div>
        </section>
        ...
        <section id="strengths" className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="glass-effect p-6 rounded-xl strength-card">
              ...
              <p className="text-gray-300">Przechwytywanie danych z różnych źródeł, identyfikowanie słabych punktów celu i planowanie optymalnej drogi "wejścia".</p>
            </div>
            <div className="glass-effect p-6 rounded-xl strength-card">
              <div className="flex items-center mb-3">
              ...
              <p className="text-gray-300">Zdolność do tworzenia niekonwencjonalnych planów i narzędzi, które skutecznie omijają standardowe "zabezpieczenia" i procedury.</p>
            </div>
            <div className="glass-effect p-6 rounded-xl strength-card">
              <div className="flex items-center mb-3">
              ...
              <p className="text-gray-300">Użycie interfejsów neuronowych do przewidywania ruchów "przeciwnika", automatyzacji włamań i łamania złożonych szyfrów.</p>
            </div>
            <div className="glass-effect p-6 rounded-xl strength-card">
              <div className="flex items-center mb-3">
              ...
              <p className="text-gray-300">Pisanie "szkodliwego" oprogramowania na zamówienie i tworzenie exploitów, które otwierają dostęp do najlepiej strzeżonych systemów.</p>
            </div>
            <div className="glass-effect p-6 rounded-xl strength-card">
              <div className="flex items-center mb-3">
              ...
              <p className="text-gray-300">Utrzymywanie wysokiego morale i żelaznej dyscypliny w "załodze", zapewniając, że każdy członek bezbłędnie wykonuje swoją rolę podczas "akcji".</p>
            </div>
            <div className="glass-effect p-6 rounded-xl strength-card">
              <div className="flex items-center mb-3">
              ...
              <p className="text-gray-300">Projektowanie wieloetapowych "scenariuszy" napadu, uwzględniających każdy możliwy ruch "ochrony" i wszystkie drogi ucieczki.</p>
            </div>
            <div className="glass-effect p-6 rounded-xl strength-card">
              <div className="flex items-center mb-3">
              ...
              <p className="text-gray-300">Zimna krew i zdolność do improwizacji, gdy "plan" zawodzi. Błyskawiczne znajdowanie wyjścia z każdej pułapki bez pozostawiania śladów.</p>
            </div>
            <div className="glass-effect p-6 rounded-xl strength-card">
              <div className="flex items-center mb-3">
              ...
              <p className="text-gray-300">Przejmowanie dowodzenia w kluczowych momentach operacji i wydawanie nieodwołalnych rozkazów, od których zależą losy całej misji.</p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-2xl mx-auto space-y-4">
              <div className="language-item">
                ...
                <div className="w-full bg-gray-700 rounded-full h-2.5 mt-1">
                  <div className="bg-green-500 h-2.5 rounded-full language-bar" style={{ width: '0%' }}></div>
                </div>
              </div>
              <div className="language-item">
      ...
      <footer className="bg-gray-900 pt-16 pb-8 px-4" id="references">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xs text-gray-600 mt-12 max-w-3xl mx-auto text-center footer-item">
            ...
            niezbędnych do realizacji procesu rekrutacji zgodnie z art. 6 ust. 1 lit. a Rozporządzenia Parlamentu
            ...
            95/46/WE (ogólne rozporządzenie o ochronie danych). Wyrażam również zgodę na przetwarzanie moich danych
            osobowych na potrzeby przyszłych procesów rekrutacyjnych.
          </p>
